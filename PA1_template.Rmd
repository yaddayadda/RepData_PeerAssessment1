---
title: "Reproducible Research Course Project - Part I"
...
The mean number of steps taken per day is `r mean_steps`, and the median is `r median_steps`. As we can see, the mean and median are not the same.
